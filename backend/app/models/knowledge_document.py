...
class KnowledgeDocument(Base):
    ...
    module:      Mapped[str | None] = mapped_column(String(50), nullable=True)   # firewall, servers, compliance, glpi — null = geral
    vendor:      Mapped[str | None] = mapped_column(String(50), nullable=True)   # fortinet, sonicwall, linux, windows, etc — null = todos
