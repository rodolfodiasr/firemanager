...
app.include_router(rmm_templates.router,       prefix="/rmm/templates",                 tags=["rmm-templates"])
app.include_router(rmm_groups.router,          prefix="/rmm/groups",                    tags=["rmm-groups"])
app.include_router(rmm.router,                 prefix="/rmm",                           tags=["rmm"])
app.include_router(server_groups.router,       prefix="/server-groups",                 tags=["server-groups"])
app.include_router(network_segments.router,    prefix="/network-segments",              tags=["network-segments"])
app.include_router(sso_mappings.router,        prefix="/sso-mappings",                  tags=["sso-mappings"])
app.include_router(file_shares.router,         prefix="/file-shares",                   tags=["file-shares"])
