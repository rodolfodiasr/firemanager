  ...
  const handleRun = async () => {
    ...
    try {
      const run = await rmmApi.run(integration.id, agent.external_id, {
        run_type: tab === "command" ? "command" : "script",
        shell,
        body: body.trim(),
        timeout,
      });
        ...
        <div className="p-5 flex-1 overflow-auto space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={tab === "command" ? "Get-Process | Select-Object -First 5" : "# Script PowerShell\nGet-ComputerInfo | Select-Object OsName, TotalPhysicalMemory"}
              value={body}
          ...
          {result && (
            <div className="border border-gray-200 rounded-lg overflow-hidden">
              ...
              <pre className="text-xs p-3 font-mono whitespace-pre-wrap text-gray-700 max-h-48 overflow-auto bg-gray-950 text-green-400">
